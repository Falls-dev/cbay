/obj/hud/proc/human_hud()
	...
	using.name = "using helmet"
	using.icon = 'ICON/mob/screen_wmask.dmi'
	...
	using.screen_loc = "0, SOUTH to 0,NORTH"
	using.layer = 19
	adding += using
/*
...
/*	using = new h_type( src )
	...
	using.name = "id"
	using.dir = SOUTHWEST
	using.icon = 'ICON/mob/screen_emini.dmi'
	using.icon_state = "id"
	...
	using = new h_type( src )
	using.name = "storage1"
	using.icon = 'ICON/mob/screen_emini2.dmi'
	using.icon_state = "l_pocket"
...
*/
	...
	mymob.toxin.icon = 'ICON/mob/screen1.dmi'
