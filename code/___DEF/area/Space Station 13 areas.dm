...
/area/atmos
 	name = "Atmospherics"
 	icon_state = "atmos"
 	music = list('OGGS/ambience/ambiatm1.ogg')
...
/area/shieldgen
	...
	icon_state = "shield"
	music = 'OGGS/machines/hiss.ogg'


/area/bridge
	name = "Bridge"
	icon_state = "bridge"
	music = 'OGGS/machines/signal.ogg'
...
/area/engine/engine_control
	...
	music = list('OGGS/ambience/ambieng1.ogg')
...
/area/medical/morgue
	name = "Morgue"
	icon_state = "morgue"
	music = list('OGGS/ambience/ambimo1.ogg','OGGS/ambience/ambimo2.ogg')
...
/area/chapel/main
	name = "Chapel"
	icon_state = "chapel"
	music = list('OGGS/ambience/ambicha1.ogg','OGGS/ambience/ambicha2.ogg','OGGS/ambience/ambicha3.ogg','OGGS/ambience/ambicha4.ogg')
