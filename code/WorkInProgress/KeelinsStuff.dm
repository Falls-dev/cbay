/obj/signpost
	icon = 'ICON/misc/old_or_unused.dmi'
	icon_state = "signpost"
	anchored = 1
	density = 1
...
/area/beach
	...
	New()
		...
		mysound = S
		S.file = 'OGGS/ambience/shore.ogg'
		S.repeat = 1
		S.wait = 0
		S.channel = 123
		S.volume = 100
	...
	proc/process()
		...
		var/sound_delay = 0
		if(prob(25))
			S = sound(file=pick('OGGS/ambience/seag1.ogg','OGGS/ambience/seag2.ogg','OGGS/ambience/seag3.ogg'), volume=100)
...
/obj/fake_attacker/proc/proccess()
	...
	if(get_dist(src,my_target) > 1)
		...
		if(prob(15))
			if(weapon_name)
				my_target << sound(pick('OGGS/weapons/genhit1.ogg', 'OGGS/weapons/genhit2.ogg', 'OGGS/weapons/genhit3.ogg'))
				...
				my_target << sound(pick('OGGS/weapons/punch1.ogg','OGGS/weapons/punch2.ogg','OGGS/weapons/punch3.ogg','OGGS/weapons/punch4.ogg'))
...
/proc/fake_blood(var/mob/target)
	...
	O.name = "blood"
	var/image/I = image('ICON/effects/blood.dmi',O,"floor[rand(1,7)]",O.dir,1)
	target << I
	spawn(300)
		del(O)
	return
