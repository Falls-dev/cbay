/sound/turntable/test
	file = 'OGGS/turntable/TestLoop1.ogg'
	falloff = 2
	repeat = 1
...
/obj/machinery/party/turntable/Topic(href, href_list)
	...
	if( href_list["on1"] )
		if(src.playing == 0)
			...
			var/sound/S = sound('OGGS/turntable/TestLoop1.ogg')
			S.repeat = 1
			S.channel = 10
			S.falloff = 2
			S.wait = 1
	...
	if( href_list["on2"] )
		if(src.playing == 0)
			//world << "Should be working..."
			var/sound/S = sound('OGGS/turntable/TestLoop2.ogg')
			S.repeat = 1
			S.channel = 10
			S.falloff = 2
			S.wait = 1
	...
	if( href_list["on3"] )
		if(src.playing == 0)
			//world << "Should be working..."
			var/sound/S = sound('OGGS/turntable/TestLoop3.ogg')
			S.repeat = 1
			S.channel = 10
			S.falloff = 2
			S.wait = 1
