...
/obj/item/weapon/hand_labeler
   icon = 'ICON/misc/old_or_unused.dmi' //this stuff probably isn't current for bs12
   icon_state = "labeler"
   item_state = "flight"
   name = "Hand labeler"
...
/obj/item/weapon/label
   icon = 'ICON/misc/old_or_unused.dmi' //I used the fingerprinted fingerprint card for this, I'm sure someone will be willing to come up with something better
