...
/obj/machinery/vending/cyberbar
	density = 0
	name = "Cyber Bar Vendor"
	desc = "Oh, free cyberpiss."
	icon_state = "cyberbar"
	icon_vend = "cyberbar"
	points = 10
	product_paths = "/obj/item/weapon/reagent_containers/food/drinks/coffee"
