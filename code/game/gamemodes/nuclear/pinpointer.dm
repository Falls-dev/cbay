/obj/item/weapon/pinpointer
	...
	proc/work()
		...
		if(the_disk.loc.z > src.loc.z)
			var/icon/zdirection = icon('ICON/obj/device.dmi', "pindown")
			overlays += zdirection
		else if(the_disk.loc.z < src.loc.z)
			var/icon/zdirection = icon('ICON/obj/device.dmi', "pinup")
			overlays += zdirection
		else
			var/icon/zdirection = icon('ICON/obj/device.dmi', "pinlevel")
			overlays += zdirection
