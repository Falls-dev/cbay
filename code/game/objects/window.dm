...
/obj/window/hitby(AM as mob|obj)
	...
	if(reinf) tforce /= 4.0
	playsound(src.loc, 'OGGS/effects/Glasshit.ogg', 100, 1)
...
/obj/window/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if (istype(W, /obj/item/weapon/screwdriver))
		if(reinf && state >= 1)
			state = 3 - state
			playsound(src.loc, 'OGGS/items/Screwdriver.ogg', 75, 1)
