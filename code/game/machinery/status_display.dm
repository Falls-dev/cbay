...
/obj/machinery/status_display
	icon = 'ICON/obj/status_display.dmi'
	icon_state = "frame"
	name = "status display"
	anchored = 1
	density = 0
	...
	proc/set_picture(var/state)
		picture_state = state
		overlays = null
		overlays += image('ICON/obj/status_display.dmi', icon_state=picture_state)
	...
	proc/texticon(var/tn, var/px = 0, var/py = 0)
		var/image/I = image('ICON/obj/status_display.dmi', "blank")
		...
		for(var/d = 1 to len)
			...
			var/image/ID = image('ICON/obj/status_display.dmi', icon_state=char)
