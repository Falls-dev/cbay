...
/obj/machinery/bot/mulebot
	...
	attackby(var/obj/item/I, var/mob/user)
		if(istype(I,/obj/item/weapon/card/emag))
			...
			playsound(src.loc, 'OGGS/effects/sparks1.ogg', 100, 0)
	...
	proc/load(var/atom/movable/C)
		if((wires & wire_loadcheck) && !istype(C,/obj/crate))
			...
			playsound(src.loc, 'OGGS/machines/buzz-sigh.ogg', 50, 0)
					...
					if(istype( next, /turf/simulated))
						...
						if(moved)
							...
							if(blockcount == 3)
								...
								playsound(src.loc, 'OGGS/machines/buzz-two.ogg', 50, 0)
							...
							if(blockcount > 5)	// attempt 5 times before recomputing
								...
								spawn(2)
									...
									if(path.len > 0)
										...
										playsound(src.loc, 'OGGS/machines/ping.ogg', 50, 0)
									mode = 4
								mode =6
								return
							return
	...
	proc/at_target()
		if(!reached_target)
			...
			playsound(src.loc, 'OGGS/machines/chime.ogg', 50, 0)
			reached_target = 1
