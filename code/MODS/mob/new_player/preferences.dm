datum/preferences
	...
	proc/update_preview_icon()
		...
		preview_icon = new /icon('ICON/mob/human.dmi', "body_[g]_s")
		...
		if (underwear > 0)
			preview_icon.Blend(new /icon('ICON/mob/human.dmi', "underwear[underwear]_[g]_s"), ICON_OVERLAY)
		...
		var/icon/hair_s = new/icon("icon" = 'ICON/mob/human_face.dmi', "icon_state" = "[h_style_r]_s")
		hair_s.Blend(rgb(r_hair, g_hair, b_hair), ICON_ADD)

		var/icon/facial_s = new/icon("icon" = 'ICON/mob/human_face.dmi', "icon_state" = "[f_style_r]_s")
