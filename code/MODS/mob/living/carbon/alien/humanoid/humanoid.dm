...
/mob/living/carbon/alien/humanoid/New()
	...
	if(!istype(src, /mob/living/carbon/alien/humanoid/queen))
		stand_icon = new /icon('ICON/mob/alien.dmi', "alien_s")
		lying_icon = new /icon('ICON/mob/alien.dmi', "alien_l")
	icon = stand_icon
...
/mob/living/carbon/alien/humanoid/update_clothing()
	...
	if (wear_suit)
		...
		overlays += image("icon" = 'ICON/mob/mob.dmi', "icon_state" = text("[][]", t1, (!( lying ) ? null : "2")), "layer" = MOB_LAYER)
		if (wear_suit.blood_DNA)
			if (istype(wear_suit, /obj/item/clothing/suit/armor))
				overlays += image("icon" = 'ICON/effects/blood.dmi', "icon_state" = "armorblood[!lying ? "" : "2"]", "layer" = MOB_LAYER)
			else
				overlays += image("icon" = 'ICON/effects/blood.dmi', "icon_state" = "suitblood[!lying ? "" : "2"]", "layer" = MOB_LAYER)
	...
	if (head)
		...
		overlays += image("icon" = 'ICON/mob/mob.dmi', "icon_state" = text("[][]", t1, (!( lying ) ? null : "2")), "layer" = MOB_LAYER)
		if (head.blood_DNA)
			overlays += image("icon" = 'ICON/effects/blood.dmi', "icon_state" = "helmetblood[!lying ? "" : "2"]", "layer" = MOB_LAYER)
