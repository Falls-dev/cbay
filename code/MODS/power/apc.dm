...
/obj/machinery/power/apc/proc/updateicon()
	...
	if(opened)
		...
		overlays += image('ICON/obj/power.dmi', "apcox-[locked]")	// 0=blue 1=red
		overlays += image('ICON/obj/power.dmi', "apco3-[charging]") // 0=red, 1=yellow/black 2=green


		if(operating)
			overlays += image('ICON/obj/power.dmi', "apco0-[equipment]")	// 0=red, 1=green, 2=blue
			overlays += image('ICON/obj/power.dmi', "apco1-[lighting]")
			overlays += image('ICON/obj/power.dmi', "apco2-[environ]")
