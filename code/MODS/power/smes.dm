...
/obj/machinery/power/smes/proc/updateicon()
	...
	overlays += image('ICON/obj/power.dmi', "smes-op[online]")

	if(charging)
		overlays += image('ICON/obj/power.dmi', "smes-oc1")
	else
		if(chargemode)
			overlays += image('ICON/obj/power.dmi', "smes-oc0")

	var/clevel = chargedisplay()
	if(clevel>0)
		overlays += image('ICON/obj/power.dmi', "smes-og[clevel]")
