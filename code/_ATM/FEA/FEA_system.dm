...
//				assemble_group_object(obj/movable/floor/base)
			...
			setup()
				...
				to_log ("ATMOSL: Processing Geometry")
				...
				to_log ("ATMOSL: Simulated Turfs [(world.timeofday-start_time)/10] seconds!")
				var/start_zone = world.timeofday
				ZoneSetup()
				to_log ("ATMOSL: Zones processed in [(world.timeofday-start_zone)/10] seconds!")
				var/start_turfs = world.timeofday
				for(var/turf/simulated/S in world) //Update all pathing and border information as well
					S.update_air_properties()
				to_log ("ATMOSL: Second simulated turfs processed in [(world.timeofday-start_turfs)/10] seconds!")
/*
...
*/
				...
				to_log ("ATMOSL: Geometry processed in [(world.timeofday-start_time)/10] seconds!")
