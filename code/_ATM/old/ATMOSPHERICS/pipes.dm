obj/machinery/atmospherics/pipe
	...
	simple/junction
		icon = 'ICON/obj/pipes/junction.dmi'
		icon_state = "intact"
		level = 2
	...
	tank
		...
		oxygen_agent_b
			icon = 'ICON/obj/atmospherics/red_orange_pipe_tank.dmi'
	...
	vent
		icon = 'ICON/obj/atmospherics/pipe_vent.dmi'
		icon_state = "intact"
	...
	manifold
		icon = 'ICON/obj/atmospherics/pipe_manifold.dmi'
